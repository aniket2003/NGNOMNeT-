...
int DataPacket::getSourceUEID() const
{
    return this->sourceUEID;
}

void DataPacket::setSourceUEID(int sourceUEID)
{
    this->sourceUEID = sourceUEID;
}

int DataPacket::getDestinationUEID() const
{
    return this->destinationUEID;
}

void DataPacket::setDestinationUEID(int destinationUEID)
{
